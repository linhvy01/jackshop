<?php
namespace JackStore\Blog\Controller\Adminhtml\Post;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('JackStore_blog::post')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('JackStore\Blog\Model\Post');
